...
<head>
    ...
    <style>
       ...
       .text-column {
        ...
        /* Per-page dark-mode heading/text overrides for My Baby page */
        .dark .topbar h1 {
            color: #ffffff !important;
        }
        .dark .baby-selector-container h2 {
            color: #ffffff !important;
        }
        .dark .baby-selector-container p {
            color: #ffffff !important;
        }
        .dark .babyh1,
        .dark #selectedBabyProfileHeading {
            color: #ffffff !important;
        }
        /*Dark mode sidebar*/
        .dark .sidebar {
