            ...
            <div class="container topbar d-none d-lg-block py-2" style="border-radius: 0 40px; background: linear-gradient(to right, #c1c8e4, #c4fff9)">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        ...
                        <small class="me-3" style="margin-left: 1px !important"><i class="fas fa-phone-alt me-2 text-secondary"></i><a href="#" style="color: black; font-weight: bold; padding: 2px;">+123 456 7890</a></small>
                    </div>
                </div>
            </div>
